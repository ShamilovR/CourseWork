	...
	<body>
		<div id = "container">
			...
			<div id = "sidebar">
				<br>
				<br>
				<a href="Director.php" id="addEmpl" onclick = "getElem()"><span>Изменить</span></a>
				<br>
				<br>
			...
			<div id = "content">
				<form method = "post">
					<p><label for = "ID">Введите id сотрудника: </label><input type = "text" id = "ID" placeholder = "id" required><Br>
					<br>
					<label for = "name">Введите имя сотрудника: </label><input type = "text" id = "name" placeholder = "Имя" required><Br>
					<br>
			...
			<script type="text/javascript" language="Javascript">
				function getElem(){
					...
					else alert("Ошибка! id должен быть целым числом");
