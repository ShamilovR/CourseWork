	...
	<body>
		<div id = "container">
			...
			<div id = "sidebar">
				<br>
				<br>
				<a href="Employee.php" id="editCar" onclick = "getElem()"><span>Изменить</span></a>
				<br>
				<br>
			...
			<div id = "content">
				<form method = "post">
					<p><label for = "id">Введите id автомобиля: </label><input type = "text" id = "id" placeholder = "id" required><Br>
					<br>
					<label for = "mark">Введите марку автомобиля: </label><input type = "text" id = "mark" placeholder = "Марка" required><Br>
					<br>
				...
				function getElem(){
					...
					if(!isNaN(id)){
						...
						if(!Number.isInteger(id))
							alert("id - целое число!");
						else count++;
					}
					else alert("Ошибка! id авто должен быть целым числом");
